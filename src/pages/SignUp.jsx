      ...
      <main className="w-full flex flex-col md:flex-row min-h-screen">
        ...
        <section className="hidden md:flex flex-1 relative bg-surface-container-high overflow-hidden border-r border-outline-variant">
          ...
          <div className="absolute bottom-12 left-12 right-12 z-20 p-8 bg-white/80 backdrop-blur-md rounded-2xl border border-outline-variant shadow-lg">
            <h2 className="text-2xl font-bold text-on-surface mb-2">Automate Your Application Journey</h2>
            <p className="text-sm text-on-surface-variant leading-relaxed">Join thousands of job seekers who use ApplyZen to automatically find, track, and apply to jobs with high-quality tailored resumes.</p>
          </div>
        </section>
        ...
        <section className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-surface-container-lowest">
          <div className="w-full max-w-[400px] space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button disabled className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-outline-variant bg-surface opacity-60 cursor-not-allowed text-on-surface text-sm font-semibold h-[40px]" type="button" title="Google login coming soon!">
                ...
                Google
                <span className="text-[9px] font-bold text-slate-400 bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200 ml-1">Soon</span>
              </button>
              <button disabled className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-outline-variant bg-surface opacity-60 cursor-not-allowed text-on-surface text-sm font-semibold h-[40px]" type="button" title="LinkedIn login coming soon!">
                <svg className="w-5 h-5 text-[#0A66C2]" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0h.003z"></path></svg>
                LinkedIn
                <span className="text-[9px] font-bold text-slate-400 bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200 ml-1">Soon</span>
              </button>
            </div>
