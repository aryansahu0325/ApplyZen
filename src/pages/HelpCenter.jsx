import { Search, UserCircle, Rocket, ArrowRight, Zap, FileEdit, Shield, Hammer, Users, ChevronDown, MessageCircle, Mail, Sparkles } from 'lucide-react';
...
<Search className="w-5 h-5 absolute left-3 top-1/2 -translate-y-1/2 text-slate-400-variant" />
...
<Search className="w-5 h-5 absolute left-6 top-1/2 -translate-y-1/2 text-emerald-600 text-3xl" />
...
<Rocket className="w-5 h-5 text-2xl" />
</div>
...
<a className="flex items-center gap-2 font-label-md text-label-md text-emerald-600 font-bold" href="#">
                        Learn More <ArrowRight className="w-5 h-5 text-sm" />
</a>
</div>
{/* AI Automation */}
<div className="group p-6 bg-white border border-slate-300 rounded-xl hover:border-emerald-600 hover:shadow-lg transition-all duration-300">
...
<Zap className="w-5 h-5 text-2xl" />
</div>
...
<div className="group p-6 bg-white border border-slate-300 rounded-xl hover:border-emerald-600 hover:shadow-lg transition-all duration-300">
<div className="w-12 h-12 bg-emerald-50/10 rounded-lg flex items-center justify-center text-emerald-600 mb-4 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
<FileEdit className="w-5 h-5 text-2xl" />
</div>
...
<Shield className="w-5 h-5 text-2xl" />
</div>
...
<Hammer className="w-5 h-5 text-2xl" />
</div>
...
<Users className="w-5 h-5 text-3xl text-slate-400 mb-4" />
...
<ChevronDown className="w-5 h-5 arrow-icon transition-transform duration-300 text-emerald-600" />
</summary>
