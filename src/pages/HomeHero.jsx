          ...
          <div className="grid lg:grid-cols-4 gap-12 mb-20">
            <div className="lg:col-span-1">
              ...
              <p className="text-sm leading-relaxed mb-6">
                Your AI career copilot that finds opportunities, applies automatically and helps you grow faster than ever.
              </p>
              <div className="flex gap-4">
                <a className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary transition-colors text-white" href="#">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li><a className="hover:text-primary transition-colors" href="#roadmap">Roadmap</a></li>
